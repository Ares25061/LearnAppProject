  ...
  switch (kind) {
    ...
    case "audio":
      return {
        ...
        note: "Подходят прямые ссылки, MP4 со звуком и ссылки на поддерживаемые видеосервисы. Для VK/Rutube звук извлекается сервером в mp3, поэтому ожидание может занять около 20 секунд.",
      };
    case "video":
    default:
      return {
