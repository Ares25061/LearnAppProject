...
Интерактивные приложения — это open-source конструктор интерактивных учебных упражнений. Проект позволяет создавать задания в браузере, сохранять и редактировать их, открывать страницы воспроизведения и экспортировать упражнения в формате SCORM для LMS.
